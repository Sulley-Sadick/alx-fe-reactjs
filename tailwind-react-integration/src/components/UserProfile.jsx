function UserProfile() {
  return (
    <div className="user-profile mx-auto my-20 max-w-xs rounded-lg bg-gray-100 shadow-lg sm:p-4 md:max-w-sm md:p-8">
      <img
        src="https://as2.ftcdn.net/v2/jpg/10/91/01/27/1000_F_1091012713_TPfuvkjNYjX53QDLW5lpPhzI1FUBKapt.jpg"
        alt="User"
        className="rounded-full object-cover sm:h-24 sm:w-24 md:h-36 md:w-36"
      />
